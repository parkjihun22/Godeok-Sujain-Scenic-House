...
<Helmet>
  <title>평택 고덕 제일풍경채 | 분양일정 안내</title>
  <meta
    name="description"
    content="평택 고덕 제일풍경채 분양일정 안내. 평택 고덕국제신도시 수자인풍경채의 특별공급, 일반공급 1순위·2순위, 당첨자 발표, 서류접수, 정당계약 등 주요 청약 일정을 확인하세요."
  />
  <meta
    name="keywords"
    content="평택 고덕 제일풍경채 분양일정, 고덕국제신도시 수자인풍경채 청약, 평택 고덕 분양일정, 평택 고덕 제일풍경채 모집공고, 평택 고덕 제일풍경채 계약"
  />
...
<h1 className={styles.screenReaderOnly}>평택 고덕 제일풍경채 - 분양일정</h1>
<p className={styles.screenReaderOnly}>
  평택 고덕 제일풍경채 분양일정을 한눈에 확인하세요.
...
<div className={styles.textBox}>
  ...
  <div>평택 고덕 제일풍경채 분양일정을 확인하세요.</div>
</div>

<img
  className={`${styles.image4} ${isImageVisible ? styles.visible : ''}`}
  src={page1}
  alt="평택 고덕 제일풍경채 분양일정 및 청약 일정 안내"
/>
