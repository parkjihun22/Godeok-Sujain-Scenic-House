...
<Helmet>
  {/* 필수 메타 */}
  <title>평택 고덕 제일풍경채 | 공급안내</title>

  <meta
    name="description"
    content="평택 고덕 제일풍경채 공급안내. 평택 고덕국제신도시 수자인풍경채의 공급정보, 주택형 구성, 청약 절차, 제출서류 및 계약 관련 주요 내용을 확인하세요."
  />

  <meta
    name="keywords"
    content="평택 고덕 제일풍경채 공급안내, 고덕국제신도시 수자인풍경채, 평택 고덕 아파트, 평택 고덕 제일풍경채 청약, 평택 고덕 제일풍경채 모집공고"
  />
...
<div className={styles.textBox}>
  ...
  <div>평택 고덕 제일풍경채 공급정보를 확인하세요.</div>
</div>

<img
className={`${styles.image4} ${isImageVisible ? styles.visible : ''}`}
src={page1}
alt="평택 고덕 제일풍경채 공급정보 및 청약 안내 이미지"
/>
