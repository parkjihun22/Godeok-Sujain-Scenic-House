...
<Helmet>
  <title>평택 고덕 제일풍경채 | 모집공고 안내</title>

  <meta
    name="description"
    content="평택 고덕 제일풍경채 모집공고 안내. 평택 고덕국제신도시 수자인풍경채의 공급 정보, 청약 일정, 신청 자격, 당첨자 발표, 계약 절차 및 유의사항을 공식 모집공고 기준으로 확인하세요."
  />

  <meta
    name="keywords"
    content="평택 고덕 제일풍경채 모집공고, 고덕국제신도시 수자인풍경채, 평택 고덕 청약, 평택 고덕 제일풍경채 분양, 평택 고덕 제일풍경채 공급안내"
  />
...
<img
  ...
  src={page1}
  alt="평택 고덕 제일풍경채 모집공고 및 청약 안내 이미지"
