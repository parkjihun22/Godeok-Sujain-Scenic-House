...
const ComplexGuide1 = () => {
  ...
  return (
    <div className={styles.container}>
      <Helmet>
        <title>평택 고덕 제일풍경채 - 청약안내</title>
        <meta
          name="description"
          content="평택 고덕 제일풍경채 청약안내. 특별공급, 1순위·2순위 청약 일정, 신청 자격, 필요서류, 인터넷 청약 절차와 유의사항을 확인하세요."
        />
