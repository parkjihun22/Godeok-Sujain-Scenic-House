...
<Helmet>
  {/* 핵심 SEO 페이지: E모델하우스 */}
  <title>평택 고덕 제일풍경채 | E모델하우스</title>

  <meta
    name="description"
    content="평택 고덕 제일풍경채 E모델하우스 안내. 평택 고덕국제신도시 수자인풍경채의 세대 평면, 실내 구조, 공간 구성과 주거 동선을 온라인으로 확인하세요."
  />

  <meta
    name="keywords"
    content="평택 고덕 제일풍경채 E모델하우스, 평택 고덕 제일풍경채, 고덕국제신도시 수자인풍경채 평면도, 평택 고덕 아파트 모델하우스"
  />
  ...
  <meta property="og:title" content="평택 고덕 제일풍경채 | E모델하우스" />
  <meta
  ...
  <meta name="twitter:title" content="평택 고덕 제일풍경채 | E모델하우스" />
  <meta
    name="twitter:description"
    content="평택 고덕 제일풍경채 E모델하우스로 세대 평면과 실내 공간을 확인하세요."
  />
  ...
  <script type="application/ld+json">
    {JSON.stringify({
      ...
      "@type": "WebPage",
      "name": "평택 고덕 제일풍경채 - E모델하우스",
      "url": "https://www.diarivalencia.com/FloorPlan/Emodel",
      "description":
        "평택 고덕 제일풍경채 E모델하우스 페이지입니다. 세대 평면, 실내 구조, 공간 구성과 주거 동선을 온라인으로 확인할 수 있습니다.",
      "primaryImageOfPage": {
        "@type": "ImageObject",
...
<div className={styles.textBox}>
  ...
  <div>평택 고덕 제일풍경채 E모델하우스를 살펴보세요.</div>
</div>
      ...
      <h1 className={styles.screenReaderOnly}>평택 고덕 제일풍경채- E모델하우스</h1>
