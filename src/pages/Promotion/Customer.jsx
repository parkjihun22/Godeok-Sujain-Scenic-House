...
<Helmet>
  ...
  <title>평택 고덕 제일풍경채 | 관심고객등록</title>

  <meta
    name="description"
    content="평택 고덕 제일풍경채 관심고객등록 안내. 평택 고덕국제신도시 수자인풍경채의 분양 정보, 청약 일정, 모델하우스 소식 및 주요 안내를 가장 먼저 확인하세요."
  />

  <meta
    name="keywords"
    content="평택 고덕 제일풍경채 관심고객등록, 고덕국제신도시 수자인풍경채, 평택 고덕 분양, 평택 고덕 제일풍경채 청약, 평택 고덕 제일풍경채"
  />
  ...
  <meta
    property="og:title"
    content="평택 고덕 제일풍경채 | 관심고객등록"
  />

  <meta
    property="og:description"
    content="평택 고덕 제일풍경채 관심고객 등록 시 분양 일정, 모델하우스 소식, 청약 정보 등 주요 안내를 우선 받아보세요."
  />
  ...
  <meta
    ...
    content="평택 고덕 제일풍경채 관심고객 등록으로 분양 일정, 청약 정보, 모델하우스 소식을 확인하세요."
  />
  ...
  <script type="application/ld+json">
    {JSON.stringify({
      ...
      "name":"평택 고덕 제일풍경채 - 관심고객등록",

      "url":"https://www.diarivalencia.com/Promotion/Customer",

      "description":
      "평택 고덕 제일풍경채 관심고객등록 페이지입니다. 분양 일정, 청약 정보, 모델하우스 소식 등 주요 안내를 우선 제공합니다.",
      ...
      <div className={styles.customerWrap}>
        ...
        <div className={styles.customerLeft}>
          <div className={styles.textBlock}>
            <h2 className={styles.projectName}>평택 고덕 제일풍경채</h2>
