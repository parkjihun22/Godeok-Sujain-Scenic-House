...
<Helmet>
  <title>평택 고덕 제일풍경채 | 커뮤니티</title>

  <meta
    name="description"
    content="평택 고덕 제일풍경채 커뮤니티 안내. 평택 고덕국제신도시 수자인풍경채의 입주민 편의시설, 여가 공간, 커뮤니티 특화 설계와 단지 내 생활 가치를 확인하세요."
  />

  <meta
    name="keywords"
    content="평택 고덕 제일풍경채 커뮤니티, 고덕국제신도시 수자인풍경채, 평택 고덕 아파트 커뮤니티, 평택 고덕 제일풍경채 단지안내"
  />
...
<div className={styles.textBox}>
  ...
  <div>평택 고덕 제일풍경채 커뮤니티를 확인하세요.</div>
</div>

<img
  className={`${styles.image2} ${isImage2Loaded ? styles.showImage2 : ''}`}
  src={page1}
  alt="평택 고덕 제일풍경채 커뮤니티 및 입주민 편의시설 안내 이미지"
