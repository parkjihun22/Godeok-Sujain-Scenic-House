...
<Helmet>
  {/* 페이지별 메타 */}
  <title>평택 고덕 제일풍경채 | 단지배치도</title>

  <meta
    name="description"
    content="평택 고덕 제일풍경채 단지배치도 안내. 평택 고덕국제신도시 수자인풍경채의 단지 구성, 조경 특화, 커뮤니티 시설, 보행 동선 및 생활 환경을 확인하세요."
  />

  <meta
    name="keywords"
    content="평택 고덕 제일풍경채 단지배치도, 고덕국제신도시 수자인풍경채, 평택 고덕 아파트, 평택 고덕 제일풍경채 커뮤니티, 평택 고덕 제일풍경채 단지안내"
  />
  ...
  <meta
    ...
    content="평택 고덕 제일풍경채 단지 구성, 조경 설계, 커뮤니티 및 생활 동선을 확인하세요."
  />
  ...
  <script type="application/ld+json">
    {JSON.stringify({
      ...
      "name":"평택 고덕 제일풍경채 - 단지배치도",

      "url":"https://www.diarivalencia.com/ComplexGuide/intro",

      "description":
      "평택 고덕 제일풍경채 단지배치도 페이지입니다. 평택 고덕국제신도시 수자인풍경채의 단지 구성과 조경 특화, 커뮤니티 시설, 생활 동선을 확인할 수 있습니다.",
...
<div className={styles.textBox}>
  ...
  <div>평택 고덕 제일풍경채, 프리미엄 단지 가치를 완성합니다.</div>
</div>

<img
  className={`${styles.image2} ${isImage2Loaded ? styles.showImage2 : ''}`}
  src={page1}
  alt="평택 고덕 제일풍경채 단지배치도 및 단지안내 이미지"
